...
void
IsotropicPlasticityStressUpdate::computeStressInitialize(Real effective_trial_stress,
                                                 ...
                                                 const Real scalar)
{
  ...
  if (_yield_condition > 0.0)
  {
    ...
    // roundoff.
    // residual = effective_trial_stress - _yield_stress - _hardening_variable[_qp];
